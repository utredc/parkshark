...
//import be.wailsharks.parkshark.war.views.RegisterView;
...
public class MainView extends AppLayout {
    ...
    private static Tab[] getAvailableTabs() {
        ...
        tabs.add(createTab("Divisions", DivisionsView.class));
        tabs.add(createTab("Parking Lots", ParkingLotView.class));
