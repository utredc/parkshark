...
ALTER TABLE "PARKING_ALLOCATION"
    ADD CONSTRAINT "PARKING_ALLOCATION_fk0" FOREIGN KEY ("MEMBER_ID") REFERENCES "MEMBER" ("ID");

ALTER TABLE "PARKING_ALLOCATION"
    ADD CONSTRAINT "PARKING_ALLOCATION_fk1" FOREIGN KEY ("PARKING_LOT_ID") REFERENCES "PARKING_LOT" ("ID");
...
INSERT INTO CITY (CITY_ID, POSTAL_CODE, NAME)
VALUES (CITY_SEQ.NEXTVAL, '9000', 'Gent');
INSERT INTO CITY (CITY_ID, POSTAL_CODE, NAME)
VALUES (CITY_SEQ.NEXTVAL, '2800', 'Mechelen');
INSERT INTO CITY (CITY_ID, POSTAL_CODE, NAME)
VALUES (CITY_SEQ.NEXTVAL, '6969', 'Funkytown');
...
-- insert into PARKING_LOT(ID,DIVISION_ID,NAME,CITY_ID,STREET_NAME,STREET_NUMBER,MAX_CAPACITY,CONTACT_PERSON_ID,CATEGORY,PRICE_PER_HOUR, AMOUNT_OF_CARS_PARKED)
-- values(PARKING_LOT_SEQ.nextval,1,'OG ParkShark',1,'Parkeerstraat','12','123',1,'UNDERGROUND_BUILDING',4.5,0);
